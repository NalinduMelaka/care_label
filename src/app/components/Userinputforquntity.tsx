...
const Userinputforquntity = (props: Props) => {
  ...
  return (
    <tr>
      ...
      <td className='border border-black'><input type='text'onChange={(e) => setColorcode(e.target.value)} value={colorcode} className='w-20 bg-slate-200'/></td>
      <td className='border border-black'><input type='text'onChange={(e) => setColorname(e.target.value)} value={colorname} className='w-20 bg-slate-200'/></td>
      <td className='border border-black'><input type='text'onChange={(e) => setUpcno(e.target.value)} value={upcno} className='w-20 bg-slate-200'/></td>
